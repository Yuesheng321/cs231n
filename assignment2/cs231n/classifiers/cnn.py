...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # 在该网络中，卷积时，输入维度与输出维度保持不变
        W2 = np.random.normal(loc=0.0, scale=weight_scale, size=[num_filters*input_dim[1]*input_dim[2]//4, hidden_dim])
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        # pass
        p1, cache1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        ...
        da2, dw3, db3 = affine_backward(ds, cache3)
        dp1, dw2, db2 = affine_relu_backward(da2, cache2)
        dx, dw1, db1 = conv_relu_pool_backward(dp1, cache1)
